...
def yellow_handle_movemnt(keys_pressed, yellow):
...
def main():
    red = pygame.Rect(750, 225, SPACESHIP_WIDTH, SPACESHIP_HEIGHT)
    yellow = pygame.Rect(100, 225, SPACESHIP_WIDTH, SPACESHIP_HEIGHT)
    ...
    while run:
        ...
        yellow_handle_movemnt(keys_pressed, yellow)
